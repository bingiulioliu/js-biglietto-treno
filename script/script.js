...
let anniPasseggero = Number(prompt('Quanti anni hai?'));
let prezzoBiglietto;

if (anniPasseggero < 18) {
    prezzoBiglietto = ( (prezzoAlKm * 100) * scontoUnder )
    }   else if (anniPasseggero >= 65) {
    prezzoBiglietto = ( (prezzoAlKm * 100 ) * scontoOver );
    }   else {
    prezzoBiglietto = ( (prezzoAlKm * 100 ) )
    }

alert(`Il prezzo del biglietto è di €${prezzoBiglietto.toFixed(2)}`);